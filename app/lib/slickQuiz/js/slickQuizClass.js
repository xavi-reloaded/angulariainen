...
//        plugin.config = $.extend(defaults, options);
        ...
        var quizValues = (json ? json : typeof quizJSON != 'undefined' ? quizJSON : null);

        var questions = defaults.randomSort || defaults.randomSortQuestions ?
...
//                        <div class="alert"><a class="close" data-dismiss="alert">×</a><strong>Warning!</strong> Best check yo self, you're not looking too good.</div>
                        ...
                        if (plugin.config.backButtonText && plugin.config.backButtonText !== '') {
                            questionHTML.append('<a href="#" class="btn btn-info backToQuestion">' + plugin.config.backButtonText + '</a>');
                        }

                        // If response messaging is disabled or hidden until the quiz is completed,
                        // make the nextQuestion button the checkAnswer button, as well
                        if (plugin.config.disableResponseMessaging || plugin.config.completionResponseMessaging) {
                            questionHTML.append('<a href="#" class="btn btn-info nextQuestion checkAnswer">' + plugin.config.nextQuestionText + '<i class="icon-arrow-right icon-white"></i></a>');
                        } else {
                            questionHTML.append('<a href="#" class="btn btn-info nextQuestion">' + plugin.config.nextQuestionText + '<i class="icon-arrow-right icon-white"></i></a>');
                            questionHTML.append('<a href="#" class="btn btn-info checkAnswer">' + plugin.config.checkAnswerText + '</a>');
                        }
