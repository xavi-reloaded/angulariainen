        ...
        <ul id="timeline" style="top: -{{screenOnFront}}%;" ng-cloak>
            ...
            <li class="show-progress">
                <div class="hero-unit">
                    ...
                    <p class="btn btn-success btn-large" ng-click="next(1)">48%</p>
            ...
            <li class="certificate">
                ...
                <div class="hero-unit">
                    ...
                    <div class="btn-group">
                        <button class="btn btn-large btn-success">Facebook<i class="icon-star icon-white"></i></button>
                        <button class="btn btn-large btn-success">Twitter <i class="icon-star icon-white"></i></button>
                    </div>
